...
@inbounds function get_propagators(; fbU::Array{ComplexF64, 3}, Jw::Vector{T}, β, dt, ntimes, rmax, build_propagator, cutoff=-1, svec=[1.0 -1.0], verbose::Bool=false, reference_prop=false) where {T<:SpectralDensities.SpectralDensity}
...
@inbounds function get_propagators_approx(; fbU::Array{ComplexF64, 3}, Jw::Vector{T}, β, dt, ntimes, rmax, build_propagator, cutoff=-1, svec=[1.0 -1.0], verbose::Bool=false, reference_prop=false) where {T<:SpectralDensities.SpectralDensity}
