...
function _precompile_()
    ...
    Base.precompile(Tuple{typeof(Core.kwcall),NamedTuple{(:β, :dt, :kmax, :imaginary_only), Tuple{Float64, Float64, Int64, Bool}},typeof(QuantumDynamics.EtaCoefficients.calculate_η),QuantumDynamics.SpectralDensities.ExponentialCutoff})
