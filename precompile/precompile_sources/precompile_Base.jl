...
function _precompile_()
    ...
    Base.precompile(Tuple{typeof(Base.Cartesian._nloops),Int64,Symbol,Expr,Expr,Vararg{Expr}})
    ...
    Base.precompile(Tuple{typeof(Core.kwcall),NamedTuple{(:stop, :step), Tuple{Float64, Float64}},typeof(range),Float64})
    ...
    Base.precompile(Tuple{typeof(materialize!),SubArray{ComplexF64, 2, Array{ComplexF64, 3}, Tuple{Int64, Slice{OneTo{Int64}}, Slice{OneTo{Int64}}}, true},Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{2}, Nothing, typeof(identity), Tuple{Matrix{ComplexF64}}}})
